...
**📄 Curriculum Vitae:** <a href="/cv/?v={{ site.time | date: '%Y%m%d%H%M' }}" target="_blank" rel="noopener">View English CV Online</a>  
...
**📄 个人简历：** <a href="/cv-zh/?v={{ site.time | date: '%Y%m%d%H%M' }}" target="_blank" rel="noopener">在线查看中文简历</a>  
简历语言与当前主页语言一致。
</div>
