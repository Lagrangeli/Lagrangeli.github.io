...
**📄 Curriculum Vitae:** <a href="/cv-en.pdf?v={{ site.time | date: '%Y%m%d%H%M' }}" target="_blank" rel="noopener">Open English PDF</a>  
...
**📄 个人简历：** <a href="/cv-zh.pdf?v={{ site.time | date: '%Y%m%d%H%M' }}" target="_blank" rel="noopener">打开中文 PDF</a>  
简历语言与当前主页语言一致。
</div>
